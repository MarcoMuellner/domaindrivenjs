...
describe("entity", () => {
  ...
  describe("entity creation", () => {
    ...
    it("should throw ValidationError for invalid data", () => {
      ...
      // Act & Assert
      expect(() => TestEntity.create(invalidData)).toThrow(ValidationError);
  ...
  describe("historization", () => {
    ...
    it("should accumulate history across multiple updates", () => {
      ...
      // Act
      const updated1 = HistorizedEntity.update(instance, {
        value: "first update",
      });
      const updated2 = HistorizedEntity.update(updated1, {
        value: "second update",
      });
  ...
  describe("entity extension", () => {
    ...
    it("should allow changing the identity field when extending", () => {
      ...
      expect(instance.toString()).toBe(
        "ExtendedEntity(123e4567-e89b-12d3-a456-426614174000)",
      );
    });
    ...
    it("should allow extending with historization", () => {
      ...
      const updated = HistorizedTestEntity.update(instance, {
        name: "Updated Name",
      });
      expect(updated._history).toBeDefined();
      expect(updated._history.length).toBe(1);
  ...
  describe("value object integration", () => {
    ...
    it("should correctly compare value objects in deep equality check", () => {
      ...
      expect(changedUser._history[0].changes[0].from.toString()).toBe(
        "John Doe",
      );
