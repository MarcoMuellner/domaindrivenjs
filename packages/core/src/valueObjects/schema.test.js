...
describe('valueObjectSchema', () => {
    it('should create a schema that validates value objects', () => {
        ...
        // Act & Assert
        // Valid cases
        expect(() => schema.parse({ name: 'Test', valueObj: strValue })).not.toThrow();
        expect(() => schema.parse({ name: 'Test', valueObj: numValue })).not.toThrow();

        // Invalid cases
        expect(() => schema.parse({ name: 'Test', valueObj: regularObject })).toThrow();
    ...
    it('should use custom type checking function', () => {
        ...
        const moneySchema = valueObjectSchema({
            typeName: 'MoneyValue',
            typeCheck: (val) => val instanceof Object &&
...
describe('specificValueObjectSchema', () => {
    ...
    it('should correctly handle extended value objects', () => {
        ...
        const extendedInstance = ExtendedValue.create({ value: 'extended', extra: true });
    ...
    it('should work with Zod default values', () => {
        ...
        const schemaWithDefault = z.object({
            id: z.string(),
            name: specificValueObjectSchema(NonEmptyString).default(defaultNonEmptyString)
        });
